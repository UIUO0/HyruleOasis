...
const gamesList: Game[] = [
...

  {
    ...
    displayTitle: "The Legend of Zelda: Ocarina of Time 3D",
    subtitleAr: "الأسطورة الخالدة بتجربة بصرية مجددة.",
    synopsisAr: "النسخة المحسنة (Remake) للعبة أكرينة الزمن الكلاسيكية، تجمع بين استكشاف هايرول والمعابد الأيقونية بتجربة لعب أسهل ورسوميات أفضل بكثير.",
    releaseDate: "2011-06-16",
    platformsAr: ["جهاز نينتيندو الرسمي", "Lime3DS على البيسي", "Lime3DS على الأندرويد", "Folium على الايفون"],
    downloadUrl: "https://romsfun.com/download/the-legend-of-zelda-ocarina-of-time-3d-42727/7",
    popularity: 3,
    storyOrder: 4,
    assetExt: "webp",
    shotExt: "webp"
  ...
  {
    slug: "majoras-mask",
    displayTitle: "The Legend of Zelda: Majora's Mask",
    ...
    platformsAr: ["جهاز نينتيندو الرسمي", "RetroArch على البيسي", "Lemuroid على الأندرويد", "Delta على الايفون"],
    downloadUrl: "https://romsfun.com/download/the-legend-of-zelda-majoras-mask-9590/1",
    downloadNote: "اخترنا توفير نسخة Redux المعدلة لأنها تحل المزعج من مشاكل النسخة القديمة وتثري التجربة بتطويرات ممتازة تجعلها النسخة الأفضل للعب.",
    popularity: 5,
    storyOrder: 5,
    assetExt: "webp",
    shotExt: "webp"
  ...
  },
  {
    ...
    platformsAr: ["جهاز نينتيندو الرسمي (GBA)", "RetroArch على البيسي", "Lemuroid على الأندرويد", "Delta على الايفون"],
  ...
  },
  {
    ...
    platformsAr: ["جهاز نينتيندو الرسمي (GameCube)", "محاكي Dolphin على البيسي", "محاكي Dolphin على الأندرويد", "محاكي DolphiniOS على الايفون"],
  ...
  {
    slug: "twilight-princess-hd",
    displayTitle: "The Legend of Zelda: Twilight Princess HD",
    subtitleAr: "حقبة مظلمة بطابع ملحمي جاد، الآن بنسخة محسّنة.",
    synopsisAr: "النسخة المحسنة عالية الدقة (HD) للعبة توايلايت برينسيس الأيقونية. عالم أعمق ونبرة أكثر جدية، مع دنجنز قوية ومعارك زعماء من الأفضل في تاريخ السلسلة.",
    releaseDate: "2016-03-04",
    platformsAr: ["جهاز نينتيندو الرسمي (Wii U)", "محاكي Cemu على البيسي", "لا يوجد على الأندرويد", "لا يوجد على الايفون"],
    downloadUrl: "https://romsfun.com/download/the-legend-of-zelda-twilight-princess-hd-39120/2",
    popularity: 4,
    storyOrder: 6,
    assetExt: "webp",
    shotExt: "webp"
  ...
  },
  {
    ...
    platformsAr: ["جهاز نينتيندو الرسمي (3DS)", "محاكي Citra / Lime3DS على البيسي", "محاكي Citra / Lime3DS على الأندرويد", "محاكي Folium على الايفون"],
  ...
  },
  {
    ...
    platformsAr: ["جهاز نينتيندو الرسمي (Wii U / Switch)", "محاكي Cemu أو Ryujinx / Suyu على البيسي", "محاكي Yuzu / Suyu على الأندرويد", "لا يوجد على الايفون"],
  ...
  // --- 1. سلسلة Hyrule Warriors والألعاب الفرعية ---
  {
    ...
    platformsAr: ["جهاز نينتيندو الرسمي (Switch)", "محاكي Ryujinx / Suyu على البيسي", "محاكي Yuzu / Suyu على الأندرويد", "لا يوجد على الايفون"],
  ...
  {
    slug: "battle-quest",
    displayTitle: "The Legend of Zelda: Battle Quest",
    subtitleAr: "مغامرة قتالية تعاونية من عالم Nintendo Land.",
    synopsisAr: "تجربة قتالية فريدة تعتمد على التعاون، حيث تستخدم السيف أو القوس لاختراق حصون الأعداء في مراحل مستوحاة من تاريخ هايرول.",
    releaseDate: "2012-11-18",
    platformsAr: ["جهاز نينتيندو الرسمي (Wii U)", "محاكي Cemu على البيسي", "لا يوجد على الأندرويد", "لا يوجد على الايفون"],
    downloadUrl: "https://romsfun.com/roms/wii-u/nintendo-land.html",
    downloadNote: "لماذا تتواجد هذه اللعبة هنا؟\n\"رغم أن Battle Quest لم تصدر كلعبة مستقلة، بل كجزء من تجميعة ألعاب Nintendo Land، إلا أنها تمثل تجربة رسمية وممتعة جداً، ونهدف في واحة هايرول إلى توثيق كل تجربة رسمية مهما كانت طريقة إصدارها.\"\n\nكيف تقوم بتشغيل اللعبة؟\n\"للعب هذه النسخة، ستقوم بتحميل ملف لعبة Nintendo Land. بعد تشغيلها عبر محاكي Cemu، قم بالدخول إلى الساحة الرئيسية (Plaza) داخل اللعبة، ثم توجه إلى البوابة الخاصة بـ Battle Quest لتبدأ مغامرتك.\"",
    popularity: 35,
    storyOrder: 99,
    assetExt: "webp",
    shotExt: "webp"
  ...
  // --- 2. إصدارات Master Quest ---
  {
    ...
    platformsAr: ["جهاز نينتيندو الرسمي (GameCube)", "Dolphin على البيسي", "Dolphin على الأندرويد", "DolphiniOS على الايفون"],
