...
const gamesList: Game[] = [
  ...
  {
    slug: "zelda-game-and-watch-2021",
    displayTitle: "Zelda (Game & Watch: The Legend of Zelda)",
    subtitleAr: "احتفالية في جهاز مصغر كلاسيكي.",
    synopsisAr: "إصدار حديث لجهاز Game & Watch الكلاسيكي، يحتوي على الألعاب الثلاث الكلاسيكية الأولى بالإضافة إلى نسخة معدلة من لعبة Vermin بشخصية لينك.",
    releaseDate: "2021-11-12",
    platformsAr: ["جهاز Game & Watch", "MAME على البيسي", "RetroArch على الأندرويد", "RetroArch على الايفون"],
    downloadUnavailable: true,
    popularity: 37,
    storyOrder: 99,
    assetExt: "webp",
